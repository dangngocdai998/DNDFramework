...
public class TextData : MonoBehaviour
{
    ...
    const string eventUpdateData = "UpdateData";

    public void OnEnable()
    {
        this.RegisterListener(eventUpdateData, (obj) => UpdateDataView(obj != null ? (DataUpdateType)obj : typeData));
        UpdateDataView(typeData);
    }
    public void OnDisable()
    {
        this.RemoveListener(eventUpdateData);
    }
