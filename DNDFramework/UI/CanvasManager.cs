...
namespace DNDFramework.UI
{
    ...
    public class CanvasManager : DNDFramework.SingletonMono<CanvasManager>
    {
        ...
        protected virtual void Awake()
        {
            ...
            _UIRectTrans.transform.localPosition = Vector3.zero;
        ...
        {
            if (OpenedUIStack[(int)menu.UILayer].Count <= 0 || menu == null)
            {
                return true;
            }
            ...
            if (index >= 0)
            {
                ...
                //        DNDFramework.Analytics.TrackingManager.I.TrackMenuActiveTime(menu.UIIdentifier, menu.MenuActiveTime);
        ...
        {
            if (OpenedUIStack.Count <= 0 || (int)layer >= OpenedUIStack.Count) return;
