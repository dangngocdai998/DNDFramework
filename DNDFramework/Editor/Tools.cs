...
{
    [MenuItem("DNDTools/Screen Shot With Canvas &q")]
    ...
    /* [MenuItem("DNDTools/OpenLoginScene &1")]
    private static void OpenLoginScene()
    {
        EditorSceneManager.OpenScene("Assets/AmetaGameProject/Scenes/SceneGame/LoginScene.unity");
    }
    [MenuItem("DNDTools/OpenHouseScene &2")]
    private static void OpenHouseScene()
    {
        EditorSceneManager.OpenScene("Assets/AmetaGameProject/Scenes/SceneGame/HouseScene.unity");
    } */
